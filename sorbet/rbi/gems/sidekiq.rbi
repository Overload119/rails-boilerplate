...
class Sidekiq::Metrics::Query::Result < Anonymous_Struct_45
  def initialize; end
...
class Sidekiq::Metrics::Query::JobResult < Anonymous_Struct_46
...
class Sidekiq::Metrics::Query::MarkResult < Anonymous_Struct_47
  def bucket; end
end
class Sidekiq::Stats
  def dead_size; end
...
class Sidekiq::JobSet < Sidekiq::SortedSet
  ...
  def find_job(jid); end
  def kill_all(notify_failure: nil, ex: nil); end
  def pop_each; end
  def retry_all; end
...
class ActiveJob::QueueAdapters::SidekiqAdapter::JobWrapper < Sidekiq::ActiveJob::Wrapper
end
