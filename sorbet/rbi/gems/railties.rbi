...
class Rails::Engine::Configuration < Rails::Railtie::Configuration
  ...
  def route_set_class=(arg0); end
end
module Rails::TestUnit
end
module Rails::TestUnit::TestParser
  def self.definition_for(method); end
  def self.ranges(filepath); end
end
...
class Rails::Application::Configuration < Rails::Engine::Configuration
  ...
  def dom_testing_default_html_version=(arg0); end
  def eager_load; end
  ...
  def precompile_filter_parameters=(arg0); end
...
class Rails::Application::Finisher::MonitorHook
  ...
  def initialize(monitor = nil); end
  def run; end
end
...
class Rails::Application::RoutesReloader
  ...
  def run_after_load_paths=(arg0); end
  def self.__callbacks; end
  def self.__callbacks=(value); end
  def self.__class_attr___callbacks; end
  def self.__class_attr___callbacks=(new_value); end
...
class Rails::Rack::Logger < ActiveSupport::LogSubscriber
  ...
  def initialize(app, taggers = nil); end
  def logger; end
...
module Rails::Command
  ...
  def self.invoke_rake(task, args, config); end
  def self.lookup_paths; end
  def self.printing_commands; end
  def self.rails_new_with_no_path?(args); end
  def self.root; end
  def self.split_namespace(namespace); end
  def self.with_argv(argv); end
  extend ActiveSupport::Autoload
...
class Rails::Generators::TestCase < ActiveSupport::TestCase
  ...
  def generator_class?; end
  def self.__class_attr_current_path; end
  def self.__class_attr_current_path=(new_value); end
  def self.__class_attr_default_arguments; end
  def self.__class_attr_default_arguments=(new_value); end
  def self.__class_attr_destination_root; end
  def self.__class_attr_destination_root=(new_value); end
  def self.__class_attr_generator_class; end
  def self.__class_attr_generator_class=(new_value); end
...
class ActiveSupport::TestCase < Minitest::Test
  ...
  def fixture_sets=(arg0); end
  def fixture_sets?; end
  def fixture_table_names; end
  def fixture_table_names=(arg0); end
  def fixture_table_names?; end
  def lock_threads; end
  def lock_threads=(arg0); end
  def lock_threads?; end
  def pre_loaded_fixtures; end
  def pre_loaded_fixtures=(arg0); end
  def pre_loaded_fixtures?; end
  def self.__class_attr_fixture_class_names; end
  def self.__class_attr_fixture_class_names=(new_value); end
  def self.__class_attr_fixture_paths; end
  def self.__class_attr_fixture_paths=(new_value); end
  def self.__class_attr_fixture_sets; end
  def self.__class_attr_fixture_sets=(new_value); end
  def self.__class_attr_fixture_table_names; end
  def self.__class_attr_fixture_table_names=(new_value); end
  def self.__class_attr_lock_threads; end
  def self.__class_attr_lock_threads=(new_value); end
  def self.__class_attr_pre_loaded_fixtures; end
  def self.__class_attr_pre_loaded_fixtures=(new_value); end
  def self.__class_attr_use_instantiated_fixtures; end
  def self.__class_attr_use_instantiated_fixtures=(new_value); end
  def self.__class_attr_use_transactional_tests; end
  def self.__class_attr_use_transactional_tests=(new_value); end
  ...
  def use_transactional_tests=(arg0); end
  def use_transactional_tests?; end
