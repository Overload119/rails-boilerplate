...
class GlobalID
  ...
  def self.default_locator(default_locator); end
...
module GlobalID::FixtureSet
  def create_global_id(fixture_set_name, label, klass:, column_type: nil, **options); end
  def global_id(fixture_set_name, label, column_type: nil, **options); end
  def signed_global_id(fixture_set_name, label, column_type: nil, **options); end
end
