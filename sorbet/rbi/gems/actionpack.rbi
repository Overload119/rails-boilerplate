...
module ActionDispatch::Session
  def self.resolve_store(session_store); end
end
...
class ActionController::ExpectedParameterMissing < ActionController::ParameterMissing
end
...
class ActionController::InvalidParameterKey < ArgumentError
end
class ActionController::Parameters
  ...
  def extract_value(key, delimiter: nil); end
  def fetch(key, *args); end
  def has_key?(*, **, &); end
  def has_value?(value); end
  def hash; end
  def hash_filter(params, filter, on_unpermitted: nil, explicit_arrays: nil); end
  def include?(*, **, &); end
  ...
  def permit_filters(filters, on_unpermitted: nil, explicit_arrays: nil); end
  ...
  def unpermitted_parameters!(params, on_unpermitted: nil); end
  def value?(value); end
  def values; end
...
class ActionDispatch::Journey::Route
  ...
  def glob?; end
  def initialize(name:, path:, app: nil, constraints: nil, required_defaults: nil, defaults: nil, request_method_match: nil, precedence: nil, scope_options: nil, internal: nil, source_location: nil); end
  def internal; end
  def ip; end
...
module ActionDispatch::Http::Cache::Request
  ...
  def self.strict_freshness; end
  def self.strict_freshness=(val); end
...
class ActionDispatch::ContentSecurityPolicy::InvalidDirectiveError < StandardError
end
...
class ActionDispatch::Routing::Mapper::Resources::Resource
  ...
  def plural; end
  def resource_scope; end
  def self.default_actions(api_only); end
  def shallow?; end
  def shallow_scope; end
  def singleton?; end
  def singular; end
...
class ActionDispatch::HostAuthorization
  ...
  def initialize(app, hosts, exclude: nil, response_app: nil); end
...
class ActionDispatch::ParamBuilder
  def default; end
  def default=(val); end
  def from_hash(hash, encoding_template: nil); end
  def from_pairs(pairs, encoding_template: nil); end
  def from_query_string(qs, separator: nil, encoding_template: nil); end
  ...
  def self.default=(val); end
  def self.from_hash(*, **, &); end
  def self.from_pairs(*, **, &); end
  def self.from_query_string(*, **, &); end
  def self.ignore_leading_brackets; end
  def self.ignore_leading_brackets=(val); end
  def self.make_default(param_depth_limit); end
  def store_nested_param(params, name, v, depth, encoding_template = nil); end
end
class ActionDispatch::QueryParser
  def self.each_pair(s, separator = nil); end
  def self.strict_query_string_separator; end
  def self.strict_query_string_separator=(val); end
...
class ActionDispatch::Request::Utils::CustomParamEncoder
  ...
  def self.encode_for_template(params, encoding_template); end
end
...
module ActionDispatch::Cookies::SerializedCookieJars
  ...
  def commit(name, options); end
  def digest; end
  def parse(name, dumped, force_reserialize: nil, **); end
...
class ActionDispatch::Request::Session
  ...
  def id_was; end
  def include?(key); end
  def initialize(by, req, enabled: nil); end
  def inspect; end
  def key?(key); end
  def keys; end
  def load!; end
...
module ActionController::RequestForgeryProtection
  ...
  def compare_with_global_token(token, session = nil); end
  def compare_with_real_token(token, session = nil); end
  ...
  def real_csrf_token(_session = nil); end
  ...
  def valid_per_form_csrf_token?(token, session = nil); end
...
module ActionController::RateLimiting::ClassMethods
  def rate_limit(to:, within:, by: nil, with: nil, store: nil, name: nil, **options); end
end
...
module ActionController::AllowBrowser::ClassMethods
  def allow_browser(versions:, block: nil, **options); end
end
...
class ActionController::Base < ActionController::Metal
  ...
  def self.__class_attr___callbacks; end
  def self.__class_attr___callbacks=(new_value); end
  def self.__class_attr__default_form_builder; end
  def self.__class_attr__default_form_builder=(new_value); end
  def self.__class_attr__flash_types; end
  def self.__class_attr__flash_types=(new_value); end
  def self.__class_attr__helper_methods; end
  def self.__class_attr__helper_methods=(new_value); end
  def self.__class_attr__layout; end
  def self.__class_attr__layout=(new_value); end
  def self.__class_attr__layout_conditions; end
  def self.__class_attr__layout_conditions=(new_value); end
  def self.__class_attr__renderers; end
  def self.__class_attr__renderers=(new_value); end
  def self.__class_attr__view_cache_dependencies; end
  def self.__class_attr__view_cache_dependencies=(new_value); end
  def self.__class_attr__wrapper_options; end
  def self.__class_attr__wrapper_options=(new_value); end
  def self.__class_attr_default_url_options; end
  def self.__class_attr_default_url_options=(new_value); end
  def self.__class_attr_etag_with_template_digest; end
  def self.__class_attr_etag_with_template_digest=(new_value); end
  def self.__class_attr_etaggers; end
  def self.__class_attr_etaggers=(new_value); end
  def self.__class_attr_fragment_cache_keys; end
  def self.__class_attr_fragment_cache_keys=(new_value); end
  def self.__class_attr_helpers_path; end
  def self.__class_attr_helpers_path=(new_value); end
  def self.__class_attr_include_all_helpers; end
  def self.__class_attr_include_all_helpers=(new_value); end
  def self.__class_attr_middleware_stack; end
  def self.__class_attr_middleware_stack=(new_value); end
...
class ActionDispatch::Response
  ...
  def header; end
  def headers; end
  def initialize(status = nil, headers = nil, body = nil); end
  def media_type; end
  def message; end
  ...
  def reset_body!; end
  def response_code; end
  def self.create(status = nil, headers = nil, body = nil, default_headers: nil); end
  ...
  def self.rack_status_code(status); end
...
module ActionController::Live
  ...
  def response_body=(body); end
  def self.live_thread_pool_executor; end
  def send_stream(filename:, disposition: nil, type: nil); end
  extend ActiveSupport::Concern
end
...
module ActionDispatch::TestProcess::FixtureFile
  def file_fixture_upload(path, mime_type = nil, binary = nil); end
...
module ActionDispatch::Assertions::ResponseAssertions
  def assert_redirected_to(url_options = nil, options = nil, message = nil); end
...
module ActionDispatch::Assertions::RoutingAssertions
  ...
  def create_routes(config = nil); end
  ...
  def setup; end
  def with_routing(config = nil, &block); end
  extend ActiveSupport::Concern
end
