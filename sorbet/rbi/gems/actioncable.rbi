...
class ActionCable::Server::Configuration
  ...
  def health_check_application=(arg0); end
  ...
  def precompile_assets=(arg0); end
...
class ActionCable::Channel::Base
  ...
  def self.__class_attr___callbacks; end
  def self.__class_attr___callbacks=(new_value); end
  def self.__class_attr_periodic_timers; end
  def self.__class_attr_periodic_timers=(new_value); end
...
class ActionCable::Connection::Base
  ...
  def self.__class_attr___callbacks; end
  def self.__class_attr___callbacks=(new_value); end
  def self.__class_attr_identifiers; end
  def self.__class_attr_identifiers=(new_value); end
  def self.__class_attr_rescue_handlers; end
  def self.__class_attr_rescue_handlers=(new_value); end
...
class ActionCable::Connection::TestCase < ActiveSupport::TestCase
  ...
  def _connection_class?; end
  def connection; end
  def self.__class_attr__connection_class; end
  def self.__class_attr__connection_class=(new_value); end
...
class ActionCable::Channel::TestCase < ActiveSupport::TestCase
  ...
  def _channel_class?; end
  def connection; end
  def self.__class_attr__channel_class; end
  def self.__class_attr__channel_class=(new_value); end
...
class ActionCable::RemoteConnections::RemoteConnection
  def disconnect(reconnect: nil); end
  def identifiers; end
  def identifiers=(arg0); end
  def identifiers?; end
