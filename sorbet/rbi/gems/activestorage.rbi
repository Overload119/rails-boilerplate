...
module ActiveStorage::Attached::Model
  ...
  def reload(*); end
  def self.validate_global_service_configuration(model_class); end
  def self.validate_service_configuration(service_name, model_class, association_name); end
  extend ActiveSupport::Concern
end
...
class ActiveStorage::Service::DiskService < ActiveStorage::Service
  def compose(source_keys, destination_key, **); end
  def delete(key); end
  def delete_prefixed(prefix); end
  ...
  def headers_for_direct_upload(key, content_type:, **); end
  def initialize(root:, public: nil, **options); end
  def make_path_for(key); end
  def path_for(key); end
  def private_url(key, expires_in:, filename:, content_type:, disposition:, **); end
  def public_url(key, filename:, content_type: nil, disposition: nil, **); end
  def root; end
  def root=(arg0); end
  def stream(key); end
  def upload(key, io, checksum: nil, **); end
  def url_for_direct_upload(key, expires_in:, content_type:, content_length:, checksum:, custom_metadata: nil); end
  def url_helpers; end
  def url_options; end
end
...
class ActiveStorage::Blob < ActiveStorage::Record
  ...
  def self.__class_attr_defined_enums; end
  def self.__class_attr_defined_enums=(new_value); end
  def self.__class_attr_service; end
  def self.__class_attr_service=(new_value); end
  def self.__class_attr_services; end
  def self.__class_attr_services=(new_value); end
  def self.build_after_unfurling(io:, filename:, key: nil, content_type: nil, metadata: nil, service_name: nil, identify: nil, record: nil); end
  def self.combine_signed_id_purposes(purpose); end
  def self.compose(blobs, filename:, key: nil, content_type: nil, metadata: nil); end
  def self.create_after_unfurling!(io:, filename:, key: nil, content_type: nil, metadata: nil, service_name: nil, identify: nil, record: nil); end
  def self.create_and_upload!(io:, filename:, key: nil, content_type: nil, metadata: nil, service_name: nil, identify: nil, record: nil); end
  ...
  def self.find_signed!(id, record: nil, purpose: nil); end
  def self.find_signed(id, record: nil, purpose: nil); end
  def self.generate_unique_secure_token(length: nil); end
  ...
  def self.services?; end
  def self.signed_id_verifier; end
