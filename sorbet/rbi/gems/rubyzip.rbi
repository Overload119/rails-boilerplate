...
module Zip::Dirtyable
  def dirty?; end
  def initialize(dirty_on_create: nil); end
...
class Zip::Entry
  ...
  def extra; end
  def extra_size; end
  def extract(entry_path = nil, destination_directory: nil, &block); end
  def file?; end
  ...
  def incomplete?; end
  def initialize(zipfile = nil, name = nil, comment: nil, size: nil, compressed_size: nil, crc: nil, compression_method: nil, compression_level: nil, time: nil, extra: nil); end
  ...
  def mtime(component: nil); end
  def mtime=(value, component: nil); end
  def name; end
  def name=(param); end
  ...
  def orig_comment=(arg0); end
  def orig_compressed_size=(arg0); end
  def orig_external_file_attributes=(arg0); end
  def orig_fstype=(arg0); end
  def orig_gp_flags=(arg0); end
  def orig_name=(arg0); end
  def orig_size=(arg0); end
  def orig_unix_gid=(arg0); end
  def orig_unix_perms=(arg0); end
  def orig_unix_uid=(arg0); end
  ...
  def read_extra_field(buf, local: nil); end
  ...
  def size=(param); end
  def symlink?; end
  def time(component: nil); end
  def time=(value, component: nil); end
  def to_s; end
  def unix_gid; end
  ...
  def write_c_dir_entry(io, suppress_extra_fields: nil); end
  def write_local_entry(io, suppress_extra_fields: nil, rewrite: nil); end
...
class Zip::ExtraField::Unknown < Zip::ExtraField::Generic
  def ==(other); end
  def initialize; end
  def merge(binstr, local: nil); end
  def to_c_dir_bin; end
  def to_local_bin; end
end
...
class Zip::ExtraField < Hash
  ...
  def initialize(binstr = nil, local: nil); end
  def length; end
  def local_size; end
  def merge(binstr, local: nil); end
...
class Zip::CentralDirectory
  ...
  def write_to_stream(io, suppress_extra_fields: nil); end
  extend Forwardable
  extend Zip::Dirtyable::ClassMethods
  include Zip::Dirtyable
end
module Zip::FileSplit
  ...
  def split(zip_file_name, segment_size: nil, delete_original: nil, partial_zip_file_name: nil); end
end
class Zip::File
  ...
  def each(*args, **, &block); end
  def entries(*args, **, &block); end
  def extract(entry, entry_path = nil, destination_directory: nil, &block); end
  def find_entry(entry_name); end
  def get_entry(entry); end
  def get_input_stream(entry, &a_proc); end
  def get_output_stream(entry, permissions: nil, comment: nil, extra: nil, compressed_size: nil, crc: nil, compression_method: nil, compression_level: nil, size: nil, time: nil, &a_proc); end
  def glob(*args, **, &block); end
  def initialize(path_or_io, create: nil, buffer: nil, restore_ownership: nil, restore_permissions: nil, restore_times: nil, compression_level: nil, suppress_extra_fields: nil); end
  def initialize_cdir(path_or_io, buffer: nil); end
  ...
  def restore_times; end
  def restore_times=(arg0); end
  def self.count_entries(path_or_io); end
  def self.foreach(zip_file_name, &block); end
  def self.open(file_name, create: nil, restore_ownership: nil, restore_permissions: nil, restore_times: nil, compression_level: nil, suppress_extra_fields: nil); end
  def self.open_buffer(io = nil, create: nil, restore_ownership: nil, restore_permissions: nil, restore_times: nil, compression_level: nil, suppress_extra_fields: nil); end
  def size(*args, **, &block); end
  def to_s; end
...
class Zip::OutputStream
  ...
  def initialize(file_name, stream: nil, encrypter: nil, suppress_extra_fields: nil); end
  def put_next_entry(entry_name, comment = nil, extra = nil, compression_method = nil, level = nil); end
  def self.open(file_name, encrypter: nil, suppress_extra_fields: nil); end
  def self.write_buffer(io = nil, encrypter: nil, suppress_extra_fields: nil); end
...
class Zip::StreamableStream < Anonymous_Delegator_54
  def clean_up; end
