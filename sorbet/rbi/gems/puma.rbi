...
module Puma
  ...
  def self.deprecate_method_change(method_old, method_caller, method_new); end
...
class Puma::DSL
  ...
  def after_refork(key = nil, &block); end
  ...
  def enable_keep_alives(enabled = nil); end
  def environment(environment); end
  def extra_runtime_dependencies(answer = nil); end
  def fiber_per_request(which = nil); end
  ...
  def process_hook(options_key, key, block, cluster_only: nil); end
...
class Puma::Configuration
  ...
  def flatten; end
  def hooks; end
  def initialize(user_options = nil, default_options = nil, env = nil, &block); end
  ...
  def options; end
  def plugins; end
  def puma_default_options(env = nil); end
  def puma_options_from_env(env = nil); end
...
class Puma::Configuration::NotLoadedError < StandardError
end
class Puma::Configuration::NotClampedError < StandardError
end
...
class Puma::ErrorLogger
  ...
  def initialize(ioerr, env: nil); end
...
class Puma::LogWriter
  ...
  def initialize(stdout, stderr, env: nil); end
  def internal_write(str); end
  def log(str); end
  def parse_error(error, req); end
  def self.null(env: nil); end
  def self.stdio(env: nil); end
  def self.strings(env: nil); end
...
class Puma::ThreadPool
  ...
  def initialize(name, options = nil, server: nil, &block); end
...
class Puma::Binder
  ...
  def initialize(log_writer, options, env: nil); end
  def ios; end
  def ios=(arg0); end
  def listeners; end
...
class Puma::Cluster < Puma::Runner
  ...
  def check_workers(refork = nil); end
  ...
  def start_phased_restart(refork = nil); end
  def stats; end
  def stop; end
