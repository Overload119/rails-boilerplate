...
class PositionalGenerator::Builder
  ...
  def computed(name: nil, deps: nil, &block); end
  def convert(values); end
  def generate_values(stack); end
  def group(name: nil, &block); end
  def initialize(as_type); end
  def int(name: nil, length: nil, ranges: nil); end
  def letter(name: nil, length: nil, ranges: nil); end
  def lit(value, name: nil); end
  def oneof(name: nil, &block); end
end
...
class Faker::Books::Lovecraft < Faker::Base
  ...
  def self.sentence(word_count: nil, random_words_to_add: nil, open_compounds_allowed: nil); end
...
class Faker::Alphanumeric < Faker::Base
  ...
  def self.alphanumeric(number: nil, min_alpha: nil, min_numeric: nil); end
end
...
class Faker::ChileRut < Faker::Base
  ...
  def self.dv; end
  def self.format_rut(rut); end
  def self.full_rut(min_rut: nil, max_rut: nil, fixed: nil, formatted: nil); end
  def self.last_rut; end
  def self.rut(min_rut: nil, max_rut: nil, fixed: nil); end
end
...
class Faker::Color < Faker::Base
  ...
  def self.hex_color(args = nil); end
  def self.hsl_color(hue: nil, saturation: nil, lightness: nil); end
  def self.hsl_to_hex(a_hsl_color); end
...
class Faker::Company < Faker::Base
  ...
  def self.bs; end
  def self.buzzword; end
  def self.calculate_gst_checksum(state_code, taxpayer_number, registration_number); end
  ...
  def self.indian_gst_number(state_code: nil); end
...
class Faker::Date < Faker::Base
  ...
  def self.forward(from: nil, days: nil); end
...
class Faker::File < Faker::Base
  ...
  def self.mime_type(media_type: nil); end
end
class Faker::Finance < Faker::Base
  def self.condominium_fiscal_code(country: nil); end
...
class Faker::Hipster < Faker::Base
  ...
  def self.sentence(word_count: nil, supplemental: nil, random_words_to_add: nil, open_compounds_allowed: nil); end
...
class Faker::HTML < Faker::Base
  ...
  def self.code; end
  def self.element(tag: nil, content: nil, attributes: nil); end
  def self.emphasis; end
  def self.generate_table_row(tag, cell_count); end
  def self.heading; end
  def self.link(rel: nil); end
  def self.ordered_list; end
  def self.paragraph(sentence_count: nil, supplemental: nil, random_sentences_to_add: nil, exclude_words: nil); end
  def self.random(exclude: nil); end
...
class Faker::IdNumber < Faker::Base
  ...
  def self.danish_control_digits(birthday); end
  def self.danish_id_number(formatted: nil, birthday: nil, gender: nil); end
...
class Faker::Internet < Faker::Base
  ...
  def self.bot_user_agent(vendor: nil); end
  def self.construct_email(local_part, domain_name); end
  def self.device_token; end
  def self.domain_name(subdomain: nil, domain: nil); end
  def self.domain_suffix(safe: nil); end
  def self.domain_word; end
  def self.email(name: nil, separators: nil, domain: nil); end
...
class Faker::Lorem < Faker::Base
  def self.character; end
  def self.characters(number: nil, min_alpha: nil, min_numeric: nil); end
  ...
  def self.paragraphs(number: nil, supplemental: nil, exclude_words: nil); end
  def self.question(word_count: nil, supplemental: nil, random_words_to_add: nil, exclude_words: nil); end
  def self.questions(number: nil, supplemental: nil, exclude_words: nil); end
  def self.sentence(word_count: nil, supplemental: nil, random_words_to_add: nil, exclude_words: nil); end
  def self.sentences(number: nil, supplemental: nil, exclude_words: nil); end
  def self.word(exclude_words: nil); end
  def self.words(number: nil, supplemental: nil, exclude_words: nil); end
end
...
class Faker::X < Faker::Base
  def self.created_at; end
  def self.id; end
  def self.media(media_key); end
  def self.screen_name; end
  def self.tweet(include_media: nil, include_user: nil); end
  def self.tweet_entities; end
  def self.tweet_item; end
  def self.url; end
  def self.user; end
  def self.user_entities; end
end
class Faker::Types < Faker::Base
  ...
  def self.rb_array(len: nil, type: nil); end
...
class Faker::Vehicle < Faker::Base
  ...
  def self.license_plate(state_abbreviation: nil); end
  def self.make; end
...
class InvalidName___Class_0x00___UnavailableInEra_49 < StandardError
end
...
class Faker::Sports::Chess < Faker::Base
  ...
  def self.player; end
  def self.rating(from: nil, to: nil); end
  def self.title; end
...
class Faker::Sport < Faker::Base
  ...
  def self.sport(include_ancient: nil, include_unusual: nil); end
...
class Faker::Travel::TrainStation < Faker::Base
  def self.fill_missing_inputs_with_samples(region, type); end
  def self.name(region: nil, type: nil); end
  def self.validate_arguments(argument, correct_values, argument_name); end
end
class Faker::TvShows
end
...
module Faker::Config
  def self.default_locale=(arg0); end
  def self.locale; end
