...
class ActionView::Template::Handlers::ERB
  ...
  def self.__class_attr_erb_implementation; end
  def self.__class_attr_erb_implementation=(new_value); end
  def self.__class_attr_erb_trim_mode; end
  def self.__class_attr_erb_trim_mode=(new_value); end
  def self.__class_attr_escape_ignore_list; end
  def self.__class_attr_escape_ignore_list=(new_value); end
  def self.__class_attr_strip_trailing_newlines; end
  def self.__class_attr_strip_trailing_newlines=(new_value); end
...
class ActionView::Template::Handlers::Builder
  ...
  def self.__class_attr_default_format; end
  def self.__class_attr_default_format=(new_value); end
...
module ActionView::Layouts
  ...
  def _default_layout(lookup_context, formats, keys, require_layout = nil); end
...
class ActionView::Helpers::Tags::Base
  def add_default_name_and_field(options, field = nil); end
  def add_default_name_and_field_for_value(tag_value, options, field = nil); end
  def add_default_name_and_id(options, field = nil); end
  def add_default_name_and_id_for_value(tag_value, options, field = nil); end
...
class ActionView::Base
  ...
  def prefix_partial_path_with_controller_namespace?; end
  def self.__class_attr__routes; end
  def self.__class_attr__routes=(new_value); end
  def self.__class_attr_logger; end
  def self.__class_attr_logger=(new_value); end
  def self.__class_attr_prefix_partial_path_with_controller_namespace; end
  def self.__class_attr_prefix_partial_path_with_controller_namespace=(new_value); end
