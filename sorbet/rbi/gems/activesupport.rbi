...
class ActiveSupport::Reloader < ActiveSupport::ExecutionWrapper
  ...
  def self.__class_attr___callbacks; end
  def self.__class_attr___callbacks=(new_value); end
  def self.__class_attr_check; end
  def self.__class_attr_check=(new_value); end
  def self.__class_attr_executor; end
  def self.__class_attr_executor=(new_value); end
...
module ActiveSupport::Benchmark
  def self.realtime(unit = nil, &block); end
end
