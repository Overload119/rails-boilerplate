...
class RedisClient::Config
  def host; end
  def initialize(url: nil, host: nil, port: nil, path: nil, username: nil, password: nil, db: nil, **kwargs); end
  def path; end
  def port; end
  def server_key; end
...
module RedisClient::HasCode
  def code; end
  def initialize(message = nil, code = nil); end
end
