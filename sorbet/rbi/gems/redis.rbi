...
module Redis::Commands::SortedSets
  ...
  def zrank(key, member, withscore: nil, with_score: nil); end
  ...
  def zrevrank(key, member, withscore: nil, with_score: nil); end
...
module Redis::Commands::Streams
  ...
  def xadd(key, entry, approximate: nil, maxlen: nil, minid: nil, nomkstream: nil, id: nil); end
...
class Redis::Client < RedisClient
  ...
  def db; end
  def ensure_connected(retryable: nil, &block); end
  def host; end
  def id; end
