...
#
#   https://github.com/sorbet/sorbet-typed/new/master?filename=lib/pg-1.6.2-arm64/all/pg-1.6.2-arm64.rbi
#
...
class PG::Connection
  ...
  def async_close_portal(arg0); end
  def async_close_prepared(arg0); end
  ...
  def close; end
  def close_portal(arg0); end
  def close_prepared(arg0); end
  ...
  def self.resolve_hosts(iopts); end
  ...
  def set_chunked_rows_mode(arg0); end
  ...
  def status; end
  def sync_cancel; end
  def sync_close_portal(arg0); end
  def sync_close_prepared(arg0); end
