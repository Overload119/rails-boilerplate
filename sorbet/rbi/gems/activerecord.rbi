...
module ActiveRecord::ConnectionAdapters
  def self.register(name, class_name, path = nil); end
  def self.resolve(adapter_name); end
  extend ActiveSupport::Autoload
end
class ActiveRecord::ConnectionAdapters::SchemaReflection
  ...
  def initialize(cache_path, cache = nil); end
  def load!(pool); end
  ...
  def self.check_schema_cache_dump_version=(arg0); end
  def self.use_schema_cache_dump; end
  def self.use_schema_cache_dump=(arg0); end
  def size(pool); end
...
class ActiveRecord::ConnectionAdapters::BoundSchemaReflection
  ...
  def self.for_lone_connection(abstract_schema_reflection, connection); end
  def size; end
  def version; end
end
...
module ActiveRecord::QueryCache::ClassMethods
  def cache(&block); end
  def uncached(dirties: nil, &block); end
end
class ActiveRecord::AsynchronousQueriesTracker
  def current_session; end
  def finalize_session(wait = nil); end
  def initialize; end
...
class ActiveRecord::ConnectionAdapters::ConnectionPool
  ...
  def release_connection(existing_lease = nil); end
  def remove(conn); end
  ...
  def with_connection(prevent_permanent_checkout: nil); end
...
module ActiveRecord::ConnectionAdapters::QueryCache
  ...
  def query_cache; end
  def query_cache=(arg0); end
  def query_cache_enabled; end
  def select_all(arel, name = nil, binds = nil, preparable: nil, async: nil, allow_retry: nil); end
...
module ActiveRecord::ConnectionAdapters::QueryCache::ConnectionPoolConfiguration
  ...
  def disable_query_cache!; end
  def disable_query_cache(dirties: nil); end
  def enable_query_cache!; end
  def enable_query_cache; end
  def initialize(*, **, &); end
  def query_cache; end
...
module ActiveRecord::QueryLogs
  def self.build_handler(name, handler = nil); end
  def self.cache_query_log_tags; end
  def self.cache_query_log_tags=(arg0); end
  def self.cached_comment; end
  def self.cached_comment=(obj); end
  def self.call(sql, connection); end
  def self.clear_cache; end
  def self.comment(connection); end
  def self.escape_sql_comment(content); end
  def self.prepend_comment; end
  def self.prepend_comment=(arg0); end
  def self.query_source_location; end
  def self.rebuild_handlers; end
  def self.tag_content(connection); end
  def self.taggings; end
  def self.taggings=(taggings); end
  def self.tags; end
  def self.tags=(tags); end
  def self.tags_formatter; end
  def self.tags_formatter=(format); end
  def self.uncached_comment(connection); end
end
module ActiveRecord::QueryLogs::LegacyFormatter
  def self.format(key, value); end
  def self.join(pairs); end
end
...
module ActiveRecord::Delegation::DelegateCache
  ...
  def self.delegate_base_methods; end
  def self.delegate_base_methods=(arg0); end
end
...
class ActiveRecord::DatabaseConfigurations::HashConfig < ActiveRecord::DatabaseConfigurations::DatabaseConfig
  ...
  def default_schema_cache_path(db_dir = nil); end
  def host; end
  def idle_timeout; end
...
module ActiveRecord::ConnectionHandling
  ...
  def connected_to_all_shards(role: nil, prevent_writes: nil, &blk); end
  ...
  def with_connection(prevent_permanent_checkout: nil, &block); end
  def with_role_and_shard(role, shard, prevent_writes); end
end
module ActiveRecord::Querying
  def _load_from_sql(result_set, &block); end
  def _query_by_sql(connection, sql, binds = nil, preparable: nil, async: nil, allow_retry: nil); end
  def and(*, **, &); end
  def annotate(*, **, &); end
  def any?(*, **, &); end
  ...
  def async_find_by_sql(sql, binds = nil, preparable: nil, allow_retry: nil, &block); end
  def async_ids(*, **, &); end
  ...
  def find_by!(*, **, &); end
  def find_by(*, **, &); end
  def find_by_sql(sql, binds = nil, preparable: nil, allow_retry: nil, &block); end
  def find_each(*, **, &); end
...
module ActiveRecord::Explain
  def build_explain_clause(connection, options = nil); end
  def collecting_queries_for_explain; end
  def exec_explain(queries, options = nil); end
...
class ActiveRecord::Type::Registration
  ...
  def matches_adapter?(adapter: nil, **); end
  def name; end
  def override; end
  def priority; end
...
module ActiveRecord::Enum
  def _enum(name, values, prefix: nil, suffix: nil, scopes: nil, instance_methods: nil, validate: nil, **options); end
  ...
  def enum(name, values = nil, **options); end
...
class ActiveRecord::Enum::EnumType < ActiveModel::Type::Value
  ...
  def cast(value); end
  def deserialize(value); end
  def initialize(name, mapping, subtype, raise_on_invalid_values: nil); end
  def mapping; end
  def name; end
...
class ActiveRecord::ConnectionAdapters::ConnectionHandler
  ...
  def connected?(connection_name, role: nil, shard: nil); end
  ...
  def each_connection_pool(role = nil, &block); end
  def establish_connection(config, owner_name: nil, role: nil, shard: nil, clobber: nil); end
  ...
  def remove_connection_pool(connection_name, role: nil, shard: nil); end
  def resolve_pool_config(config, connection_name, role, shard); end
  def retrieve_connection(connection_name, role: nil, shard: nil); end
  def retrieve_connection_pool(connection_name, role: nil, shard: nil, strict: nil); end
...
class ActiveRecord::ConnectionAdapters::ConnectionHandler::ConnectionDescriptor
  ...
  def initialize(name, primary = nil); end
  def name; end
  def primary_class?; end
end
class ActiveRecord::InsertAll
  ...
  def initialize(relation, connection, inserts, on_duplicate:, update_only: nil, returning: nil, unique_by: nil, record_timestamps: nil); end
  def inserts; end
  def keys; end
...
module ActiveRecord::ModelSchema::ClassMethods
  ...
  def reload_schema_from_cache(recursive = nil); end
...
module ActiveRecord::CounterCache::ClassMethods
  ...
  def decrement_counter(counter_name, id, by: nil, touch: nil); end
  def increment_counter(counter_name, id, by: nil, touch: nil); end
  def load_schema!; end
...
module ActiveRecord::Encryption::Configurable::ClassMethods
  def cipher(*, **, &); end
  def configure(primary_key: nil, deterministic_key: nil, key_derivation_salt: nil, **properties); end
...
class ActiveRecord::Encryption::Config
  ...
  def hash_digest_class=(arg0); end
  def initialize; end
...
class ActiveRecord::Encryption::KeyGenerator
  ...
  def hash_digest_class; end
  def initialize(hash_digest_class: nil); end
  def key_derivation_salt; end
  def key_length; end
end
...
class ActiveRecord::Encryption::Encryptor
  ...
  def forced_encoding_for_deterministic_encryption; end
  def initialize(compress: nil, compressor: nil); end
...
module ActiveRecord::Encryption::EncryptableRecord::ClassMethods
  ...
  def encrypt_attribute(name, key_provider: nil, key: nil, deterministic: nil, support_unencrypted_data: nil, downcase: nil, ignore_case: nil, previous: nil, compress: nil, compressor: nil, **context_properties); end
  def encrypts(*names, key_provider: nil, key: nil, deterministic: nil, support_unencrypted_data: nil, downcase: nil, ignore_case: nil, previous: nil, compress: nil, compressor: nil, **context_properties); end
  ...
  def scheme_for(key_provider: nil, key: nil, deterministic: nil, support_unencrypted_data: nil, downcase: nil, ignore_case: nil, previous: nil, **context_properties); end
...
module ActiveRecord::AttributeMethods::Read::ClassMethods
  def define_method_attribute(canonical_name, owner:, as: nil); end
end
...
module ActiveRecord::Timestamp
  ...
  def create_or_update(touch: nil, **); end
...
module ActiveRecord::AttributeMethods::Serialization::ClassMethods
  def build_column_serializer(attr_name, coder, type, yaml = nil); end
  def serialize(attr_name, coder: nil, type: nil, yaml: nil, **options); end
...
class ActiveRecord::Coders::ColumnSerializer
  ...
  def dump(object); end
  def init_with(coder); end
  def initialize(attr_name, coder, object_class = nil); end
...
class ActiveRecord::Coders::YAMLColumn < ActiveRecord::Coders::ColumnSerializer
  ...
  def coder; end
  def init_with(coder); end
  def initialize(attr_name, object_class = nil, permitted_classes: nil, unsafe_load: nil); end
end
class ActiveRecord::Coders::YAMLColumn::SafeCoder
  def dump(object); end
  def initialize(permitted_classes: nil, unsafe_load: nil); end
  def load(payload); end
end
...
module ActiveRecord::Transactions
  ...
  def _last_transaction_return_status=(arg0); end
  def _new_record_before_last_commit; end
  def _new_record_before_last_commit=(arg0); end
...
module ActiveRecord::SecureToken::ClassMethods
  ...
  def has_secure_token(attribute = nil, length: nil, on: nil); end
end
...
module ActiveRecord::TokenFor::ClassMethods
  def find_by_token_for!(purpose, token); end
  def find_by_token_for(purpose, token); end
  def generates_token_for(purpose, expires_in: nil, &block); end
end
module ActiveRecord::SignedId
  def signed_id(expires_in: nil, expires_at: nil, purpose: nil); end
  extend ActiveSupport::Concern
end
...
module ActiveRecord::Normalization::ClassMethods
  ...
  def normalizes(*names, with:, apply_to_nil: nil); end
end
...
class ActiveRecord::SchemaDumper
  ...
  def self.dump(pool = nil, stream = nil, config = nil); end
...
module ActiveRecord::ConnectionAdapters::DatabaseStatements
  ...
  def begin_deferred_transaction(isolation_level = nil); end
  ...
  def execute_batch(statements, name = nil, **kwargs); end
  ...
  def internal_execute(sql, name = nil, binds = nil, prepare: nil, async: nil, allow_retry: nil, materialize_transactions: nil, &block); end
  ...
  def raw_execute(sql, name = nil, binds = nil, prepare: nil, async: nil, allow_retry: nil, materialize_transactions: nil, batch: nil); end
  ...
  def select(sql, name = nil, binds = nil, prepare: nil, async: nil, allow_retry: nil); end
  def select_all(arel, name = nil, binds = nil, preparable: nil, async: nil, allow_retry: nil); end
  ...
  def to_sql_and_binds(arel_or_sql_string, binds = nil, preparable = nil, allow_retry = nil); end
...
class ActiveRecord::ConnectionAdapters::AbstractAdapter
  ...
  def log(sql, name = nil, binds = nil, type_casted_binds = nil, async: nil, &block); end
  def logger; end
  def owner; end
  def pinned; end
  def pinned=(arg0); end
...
class ActiveRecord::ConnectionAdapters::Column
  ...
  def human_name; end
  def init_with(coder); end
  def initialize(name, default, sql_type_metadata = nil, null = nil, default_function = nil, collation: nil, comment: nil, **); end
  def limit(*, **, &); end
  def name; end
  def null; end
  def precision(*, **, &); end
...
class ActiveRecord::ConnectionAdapters::PostgreSQL::Column < ActiveRecord::ConnectionAdapters::Column
  ...
  def identity?; end
  def init_with(coder); end
  def initialize(*, serial: nil, identity: nil, generated: nil, **); end
  def oid(*, **, &); end
  def serial?; end
  def sql_type; end
  def virtual?; end
...
module ActiveRecord::ConnectionAdapters::PostgreSQL::DatabaseStatements
  ...
  def perform_query(raw_connection, sql, binds, type_casted_binds, prepare:, notification_payload:, batch: nil); end
...
class ActiveRecord::ConnectionAdapters::PostgreSQL::OID::Point < ActiveModel::Type::Value
  ...
  def type; end
  def type_cast_for_schema(value); end
  def values_array_from_hash(value); end
  include ActiveModel::Type::Helpers::Mutable
end
...
class ActiveRecord::ConnectionAdapters::PostgreSQL::Table < ActiveRecord::ConnectionAdapters::Table
  ...
  def point(*names, **options); end
  def polygon(*names, **options); end
  def remove_exclusion_constraint(*, **, &); end
  def remove_unique_constraint(*, **, &); end
  def serial(*names, **options); end
  def timestamptz(*names, **options); end
  def tsrange(*names, **options); end
  def tstzrange(*names, **options); end
  ...
  def uuid(*names, **options); end
  def validate_check_constraint(*, **, &); end
  def validate_constraint(*, **, &); end
  def xml(*names, **options); end
  include ActiveRecord::ConnectionAdapters::PostgreSQL::ColumnMethods
end
...
module ActiveRecord::ConnectionAdapters::PostgreSQL::SchemaStatements
  ...
  def create_schema(schema_name, force: nil, if_not_exists: nil); end
  def create_schema_dumper(options); end
  def create_table_definition(name, **options); end
  def ctype; end
  ...
  def index_name_exists?(table_name, index_name); end
  def indexes(table_name); end
  def inherited_table_names(table_name); end
  ...
  def table_comment(table_name); end
  def table_options(table_name); end
  def table_partition_definition(table_name); end
  def type_to_sql(type, limit: nil, precision: nil, scale: nil, array: nil, enum_type: nil, **); end
...
class ActiveRecord::ConnectionAdapters::PostgreSQL::TypeMetadata < Anonymous_Delegator_28
  def ==(other); end
  def deduplicated; end
  def eql?(other); end
  def fmod; end
...
class ActiveRecord::ConnectionAdapters::PostgreSQLAdapter < ActiveRecord::ConnectionAdapters::AbstractAdapter
  ...
  def rename_enum(name, new_name = nil, **options); end
  def rename_enum_value(type_name, **options); end
  def reset!; end
  def retryable_query_error?(exception); end
  def self.__class_attr_create_unlogged_tables; end
  def self.__class_attr_create_unlogged_tables=(new_value); end
  def self.__class_attr_datetime_type; end
  def self.__class_attr_datetime_type=(new_value); end
  def self.__class_attr_decode_dates; end
  def self.__class_attr_decode_dates=(new_value); end
...
class ActiveRecord::ConnectionAdapters::PoolConfig
  ...
  def disconnect!(automatic_reconnect: nil); end
  def initialize(connection_class, db_config, role, shard); end
  def pool; end
  def role; end
  def schema_reflection; end
  def schema_reflection=(arg0); end
  def self.discard_pools!; end
  def self.disconnect_all!; end
  def server_version(connection); end
  def server_version=(arg0); end
  def shard; end
  include MonitorMixin
end
class ActiveRecord::ConnectionAdapters::PoolManager
  def each_pool_config(role = nil, &block); end
...
class ActiveRecord::Base
  ...
  def normalized_attributes=(arg0); end
  def normalized_attributes?; end
  ...
  def self.__class_attr___callbacks; end
  def self.__class_attr___callbacks=(new_value); end
  def self.__class_attr__attr_readonly; end
  def self.__class_attr__attr_readonly=(new_value); end
  def self.__class_attr__counter_cache_columns; end
  def self.__class_attr__counter_cache_columns=(new_value); end
  def self.__class_attr__destroy_association_async_job; end
  def self.__class_attr__destroy_association_async_job=(new_value); end
  ...
  def self.__class_attr_aggregate_reflections; end
  def self.__class_attr_aggregate_reflections=(new_value); end
  def self.__class_attr_attachment_reflections; end
  def self.__class_attr_attachment_reflections=(new_value); end
  def self.__class_attr_attribute_aliases; end
  def self.__class_attr_attribute_aliases=(new_value); end
  def self.__class_attr_attribute_method_patterns; end
  def self.__class_attr_attribute_method_patterns=(new_value); end
  def self.__class_attr_attributes_for_inspect; end
  def self.__class_attr_attributes_for_inspect=(new_value); end
  def self.__class_attr_automatic_scope_inversing; end
  def self.__class_attr_automatic_scope_inversing=(new_value); end
  def self.__class_attr_automatically_invert_plural_associations; end
  def self.__class_attr_automatically_invert_plural_associations=(new_value); end
  def self.__class_attr_belongs_to_required_by_default; end
  def self.__class_attr_belongs_to_required_by_default=(new_value); end
  def self.__class_attr_cache_timestamp_format; end
  def self.__class_attr_cache_timestamp_format=(new_value); end
  def self.__class_attr_cache_versioning; end
  def self.__class_attr_cache_versioning=(new_value); end
  def self.__class_attr_collection_cache_versioning; end
  def self.__class_attr_collection_cache_versioning=(new_value); end
  def self.__class_attr_counter_cached_association_names; end
  def self.__class_attr_counter_cached_association_names=(new_value); end
  def self.__class_attr_default_column_serializer; end
  def self.__class_attr_default_column_serializer=(new_value); end
  def self.__class_attr_default_connection_handler; end
  def self.__class_attr_default_connection_handler=(new_value); end
  def self.__class_attr_default_role; end
  def self.__class_attr_default_role=(new_value); end
  def self.__class_attr_default_scope_override; end
  def self.__class_attr_default_scope_override=(new_value); end
  def self.__class_attr_default_scopes; end
  def self.__class_attr_default_scopes=(new_value); end
  def self.__class_attr_default_shard; end
  def self.__class_attr_default_shard=(new_value); end
  def self.__class_attr_defined_enums; end
  def self.__class_attr_defined_enums=(new_value); end
  def self.__class_attr_destroy_association_async_batch_size; end
  def self.__class_attr_destroy_association_async_batch_size=(new_value); end
  def self.__class_attr_encrypted_attributes; end
  def self.__class_attr_encrypted_attributes=(new_value); end
  def self.__class_attr_enumerate_columns_in_select_statements; end
  def self.__class_attr_enumerate_columns_in_select_statements=(new_value); end
  def self.__class_attr_generated_token_verifier; end
  def self.__class_attr_generated_token_verifier=(new_value); end
  def self.__class_attr_has_many_inversing; end
  def self.__class_attr_has_many_inversing=(new_value); end
  def self.__class_attr_immutable_strings_by_default; end
  def self.__class_attr_immutable_strings_by_default=(new_value); end
  def self.__class_attr_implicit_order_column; end
  def self.__class_attr_implicit_order_column=(new_value); end
  def self.__class_attr_include_root_in_json; end
  def self.__class_attr_include_root_in_json=(new_value); end
  def self.__class_attr_inheritance_column; end
  def self.__class_attr_inheritance_column=(new_value); end
  def self.__class_attr_internal_metadata_table_name; end
  def self.__class_attr_internal_metadata_table_name=(new_value); end
  def self.__class_attr_lock_optimistically; end
  def self.__class_attr_lock_optimistically=(new_value); end
  def self.__class_attr_logger; end
  def self.__class_attr_logger=(new_value); end
  def self.__class_attr_nested_attributes_options; end
  def self.__class_attr_nested_attributes_options=(new_value); end
  def self.__class_attr_normalized_attributes; end
  def self.__class_attr_normalized_attributes=(new_value); end
  def self.__class_attr_param_delimiter; end
  def self.__class_attr_param_delimiter=(new_value); end
  def self.__class_attr_partial_inserts; end
  def self.__class_attr_partial_inserts=(new_value); end
  def self.__class_attr_partial_updates; end
  def self.__class_attr_partial_updates=(new_value); end
  def self.__class_attr_pluralize_table_names; end
  def self.__class_attr_pluralize_table_names=(new_value); end
  def self.__class_attr_primary_key_prefix_type; end
  def self.__class_attr_primary_key_prefix_type=(new_value); end
  def self.__class_attr_record_timestamps; end
  def self.__class_attr_record_timestamps=(new_value); end
  def self.__class_attr_run_commit_callbacks_on_first_saved_instances_in_transaction; end
  def self.__class_attr_run_commit_callbacks_on_first_saved_instances_in_transaction=(new_value); end
  def self.__class_attr_schema_migrations_table_name; end
  def self.__class_attr_schema_migrations_table_name=(new_value); end
  def self.__class_attr_shard_selector; end
  def self.__class_attr_shard_selector=(new_value); end
  def self.__class_attr_signed_id_verifier_secret; end
  def self.__class_attr_signed_id_verifier_secret=(new_value); end
  def self.__class_attr_skip_time_zone_conversion_for_attributes; end
  def self.__class_attr_skip_time_zone_conversion_for_attributes=(new_value); end
  def self.__class_attr_store_full_class_name; end
  def self.__class_attr_store_full_class_name=(new_value); end
  def self.__class_attr_store_full_sti_class; end
  def self.__class_attr_store_full_sti_class=(new_value); end
  def self.__class_attr_strict_loading_by_default; end
  def self.__class_attr_strict_loading_by_default=(new_value); end
  def self.__class_attr_strict_loading_mode; end
  def self.__class_attr_strict_loading_mode=(new_value); end
  def self.__class_attr_table_name_prefix; end
  def self.__class_attr_table_name_prefix=(new_value); end
  def self.__class_attr_table_name_suffix; end
  def self.__class_attr_table_name_suffix=(new_value); end
  def self.__class_attr_time_zone_aware_attributes; end
  def self.__class_attr_time_zone_aware_attributes=(new_value); end
  def self.__class_attr_time_zone_aware_types; end
  def self.__class_attr_time_zone_aware_types=(new_value); end
  def self.__class_attr_token_definitions; end
  def self.__class_attr_token_definitions=(new_value); end
  ...
  def self.attribute_method_patterns?; end
  def self.attributes_for_inspect; end
  def self.attributes_for_inspect=(value); end
  def self.attributes_for_inspect?; end
  def self.automatic_scope_inversing; end
  def self.automatic_scope_inversing=(value); end
  def self.automatic_scope_inversing?; end
  def self.automatically_invert_plural_associations; end
  def self.automatically_invert_plural_associations=(value); end
  def self.automatically_invert_plural_associations?; end
  ...
  def self.counter_cached_association_names; end
  def self.counter_cached_association_names=(value); end
  def self.counter_cached_association_names?; end
  def self.current_preventing_writes; end
  ...
  def self.pluralize_table_names?; end
  def self.preventing_writes?(class_name); end
  ...
  def self.strict_loading_by_default?; end
  def self.strict_loading_mode; end
  def self.strict_loading_mode=(value); end
  def self.strict_loading_mode?; end
...
class ActiveRecord::Relation
  ...
  def initialize(model, table: nil, predicate_builder: nil, values: nil); end
  def initialize_copy(other); end
...
module ActiveRecord::QueryMethods
  ...
  def async!; end
  def async; end
  def build_arel(connection, aliases = nil); end
  def build_bound_sql_literal(statement, values); end
  def build_case_for_value_position(column, values, filter: nil); end
  ...
  def build_with_expression_from_value(value, nested = nil); end
  def build_with_join_node(name, kind = nil); end
  ...
  def in_order_of(column, values, filter: nil); end
  ...
  def select_named_joins(join_names, stashed_joins = nil, &block); end
...
module ActiveRecord::Batches
  ...
  def find_each(start: nil, finish: nil, batch_size: nil, error_on_ignore: nil, cursor: nil, order: nil, &block); end
  def find_in_batches(start: nil, finish: nil, batch_size: nil, error_on_ignore: nil, cursor: nil, order: nil); end
  def in_batches(of: nil, start: nil, finish: nil, load: nil, error_on_ignore: nil, cursor: nil, order: nil, use_ranges: nil, &block); end
...
class ActiveRecord::Batches::BatchEnumerator
  ...
  def finish; end
  def initialize(relation:, cursor:, of: nil, start: nil, finish: nil, order: nil, use_ranges: nil); end
  def relation; end
  def start; end
  def touch_all(*, **, &); end
  def update_all(updates); end
...
class ActiveRecord::Relation::ExplainProxy
  ...
  def minimum(column_name); end
  def pluck(*column_names); end
  def sum(identity_or_column = nil); end
end
...
module ActiveRecord::Migration::Compatibility::V6_1::TableDefinition
  def change(name, type, index: nil, **options); end
  def column(name, type, index: nil, **options); end
  def new_column_definition(name, type, **options); end
  def raise_on_if_exist_options(options); end
end
...
module ActiveRecord::Tasks::DatabaseTasks
  def cache_dump_filename(db_config, schema_cache_path: nil); end
  ...
  def db_configs_with_versions(environment = nil); end
  def db_dir; end
  def db_dir=(arg0); end
  ...
  def migrate(version = nil, skip_initialize: nil); end
  def migrate_all; end
  ...
  def reconstruct_from_schema(db_config, file = nil); end
  ...
  def schema_up_to_date?(configuration, _ = nil, file = nil); end
  def seed_loader; end
  ...
  def verbose?; end
  def with_temporary_connection(db_config, clobber: nil, &block); end
  def with_temporary_pool(db_config, clobber: nil); end
  def with_temporary_pool_for_each(env: nil, name: nil, clobber: nil, &block); end
...
class ActiveRecord::InternalMetadata
  ...
  def create_table; end
  def create_table_and_set_flags(environment, schema_sha1 = nil); end
...
class ActiveRecord::FutureResult
  ...
  def execute_query(connection, async: nil); end
...
module ActiveRecord::Assertions::QueryAssertions
  def assert_no_queries(include_schema: nil, &block); end
  def assert_no_queries_match(match, include_schema: nil, &block); end
  def assert_queries_count(count = nil, include_schema: nil, &block); end
  def assert_queries_match(match, count: nil, include_schema: nil, &block); end
end
...
class ActiveRecord::FixtureSet
  ...
  def self.cached_fixtures(connection_pool, keys_to_fetch = nil); end
  def self.check_all_foreign_keys_valid!(conn); end
  def self.composite_identify(label, key); end
  def self.context_class; end
  def self.create_fixtures(fixtures_directories, fixture_set_names, class_names = nil, config = nil); end
  ...
  def self.insert(fixture_sets, connection_pool); end
  ...
  def self.read_and_insert(fixtures_directories, fixture_files, class_names, connection_pool); end
