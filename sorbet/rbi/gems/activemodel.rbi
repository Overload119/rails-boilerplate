...
class ActiveModel::Error
  ...
  def options; end
  def raw_type; end
  def self.__class_attr_i18n_customize_full_message; end
  def self.__class_attr_i18n_customize_full_message=(new_value); end
...
module ActiveModel::AttributeMethods::ClassMethods
  ...
  def define_attribute_method(attr_name, _owner: nil, as: nil); end
  def define_attribute_method_pattern(pattern, attr_name, owner:, as:, override: nil); end
  ...
  def define_proxy_call(code_generator, name, proxy_target, parameters, *call_args, namespace:, as: nil); end
...
module ActiveModel::SecurePassword::ClassMethods
  def has_secure_password(attribute = nil, validations: nil, reset_token: nil); end
end
...
module ActiveModel::AttributeRegistration::ClassMethods
  ...
  def attribute(name, type = nil, default: nil, **options); end
  def attribute_types; end
  def decorate_attributes(names = nil, &decorator); end
...
class ActiveModel::Name
  ...
  def i18n_keys; end
  def i18n_scope; end
  def initialize(klass, namespace = nil, name = nil, locale = nil); end
  def match?(*, **, &); end
  def name; end
  def name=(arg0); end
  def param_key; end
...
module ActiveModel::Type
  ...
  def self.lookup(*, **, &); end
  def self.register(type_name, klass = nil, &block); end
...
class ActiveModel::Type::Date < ActiveModel::Type::Value
  ...
  include Anonymous_ActiveModel_Type_Helpers_AcceptsMultiparameterTime_17
end
module Anonymous_ActiveModel_Type_Helpers_AcceptsMultiparameterTime_17
...
class ActiveModel::Type::Registry
  ...
  def register(type_name, klass = nil, &block); end
