...
class ActionMailer::Base < AbstractController::Base
  ...
  def deliver_later_queue_name=(arg0); end
  def deliver_later_queue_name?; end
  ...
  def self.__class_attr_default_params; end
  def self.__class_attr_default_params=(new_value); end
  def self.__class_attr_default_url_options; end
  def self.__class_attr_default_url_options=(new_value); end
  def self.__class_attr_deliver_later_queue_name; end
  def self.__class_attr_deliver_later_queue_name=(new_value); end
  def self.__class_attr_delivery_job; end
  def self.__class_attr_delivery_job=(new_value); end
  def self.__class_attr_delivery_method; end
  def self.__class_attr_delivery_method=(new_value); end
  def self.__class_attr_delivery_methods; end
  def self.__class_attr_delivery_methods=(new_value); end
  def self.__class_attr_file_settings; end
  def self.__class_attr_file_settings=(new_value); end
  def self.__class_attr_fragment_cache_keys; end
  def self.__class_attr_fragment_cache_keys=(new_value); end
  def self.__class_attr_rescue_handlers; end
  def self.__class_attr_rescue_handlers=(new_value); end
  def self.__class_attr_sendmail_settings; end
  def self.__class_attr_sendmail_settings=(new_value); end
  def self.__class_attr_smtp_settings; end
  def self.__class_attr_smtp_settings=(new_value); end
  def self.__class_attr_test_settings; end
  def self.__class_attr_test_settings=(new_value); end
  ...
  def self.method_missing(method_name, *, **, &); end
