...
class Thor::Command < Anonymous_Struct_48
...
module Thor::Shell::Terminal
  def self.dynamic_width; end
  def self.dynamic_width_stty; end
  def self.dynamic_width_tput; end
  def self.terminal_width; end
  def self.unix?; end
end
class Thor::Shell::ColumnPrinter
  def initialize(stdout, options = nil); end
  def options; end
  def print(array); end
  def stdout; end
end
