...
module Psych
  ...
  def self.load(yaml, permitted_classes: nil, permitted_symbols: nil, aliases: nil, filename: nil, fallback: nil, symbolize_names: nil, freeze: nil, strict_integer: nil, parse_symbols: nil); end
  ...
  def self.safe_load(yaml, permitted_classes: nil, permitted_symbols: nil, aliases: nil, filename: nil, fallback: nil, symbolize_names: nil, freeze: nil, strict_integer: nil, parse_symbols: nil); end
  def self.safe_load_file(filename, **kwargs); end
  def self.safe_load_stream(yaml, filename: nil, permitted_classes: nil, aliases: nil); end
  def self.to_json(object); end
  def self.unsafe_load(yaml, filename: nil, fallback: nil, symbolize_names: nil, freeze: nil, strict_integer: nil, parse_symbols: nil); end
...
class Psych::Visitors::ToRuby < Psych::Visitors::Visitor
  ...
  def self.create(symbolize_names: nil, freeze: nil, strict_integer: nil, parse_symbols: nil); end
...
class Psych::ScalarScanner
  def class_loader; end
  def initialize(class_loader, strict_integer: nil, parse_symbols: nil); end
...
class Psych::Nodes::Node
  ...
  def stream?; end
  def tag; end
  def to_ruby(symbolize_names: nil, freeze: nil, strict_integer: nil, parse_symbols: nil); end
  def to_yaml(io = nil, options = nil); end
  def transform(symbolize_names: nil, freeze: nil, strict_integer: nil, parse_symbols: nil); end
...
class Psych::Parser::Mark < Anonymous_Struct_8
end
class Psych::Coder
  def [](k); end
  def []=(k, v); end
...
class InvalidName___Class_0x00___Config_9
